...
func main() {
	...
	timeoutTCP := flag.Int("timeout", 2, "Session timeout. Options: Any int in range 1-65534")
	timeoutUDP := flag.Int("timeout", 5, "Session timeout. Options: Any int in range 1-65534")
